...
- 회사명: 슈퍼컴퍼니
- 팀명: 서비스개발1팀
- 팀장 (보고 수신자): jn.kim <fastkjn1@gmail.com>
- 보고자: Jina Kim <fastkjn1@gmail.com>
- 보고 주기: 매주 금요일 오전
- 어투: 격식체
...
## 소스 데이터 위치
- STT 텍스트 파일 (회의 녹음 변환본): D:\report-project\skills\회의록\references\회의녹음\
- 회의록 (Google Drive): ${GOOGLE_DRIVE_FOLDER_URL}
- 업무 결과물 (Google Drive): ${GOOGLE_DRIVE_FOLDER_URL}
- 업무 관련 메일: Gmail (최근 1주일 수발신 메일)

---

## 보고서 양식 & 저장
- 양식 파일: D:\report-project\week_pptx\주간보고서.pptx
- IMPORTANT: 양식 파일 수정·덮어쓰기 절대 금지. 반드시 복사본에 작업할 것.
- 저장 위치: D:\report-project\week_pptx\weekly_report\주간보고서.pptx
- 파일명 규칙: 주간보고서_YYYYMMDD_v1.pptx (수정 시 v2, v3으로 버전 올림)
- 이메일 제목 형식: [주간보고] YYYY년 MM월 N주차 업무 요약
...
비교 대상:
- STT 파일 목록: D:\report-project\skills\회의록\references\회의녹음\ 폴더의 *_STT원본.txt
...
Google Drive 업무 결과물 폴더 (${GOOGLE_DRIVE_FOLDER_URL}) 에서
...
- 저장: D:\report-project\week_pptx\weekly_report\주간보고서_YYYYMMDD_v1.pptx
...
파일 보관: D:\report-project\week_pptx\weekly_report\발송완료\주간보고서_YYYYMMDD_v1.pptx
```
